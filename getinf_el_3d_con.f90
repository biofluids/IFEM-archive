       ...
       subroutine getinf_el_3d_con(finf, x, xna, nn, nsd, ne, nen, ien, maxconn,nn_con_ele,con_ele,index_con)
	   implicit none
	   ...
	   integer isd  
	   integer i
	   integer icount,nn_con_ele,con_ele(nn_con_ele),inf_con(maxconn),index_con
       inf_con(:)=0
       index_con=0
       ninf = 0
       finf=0
