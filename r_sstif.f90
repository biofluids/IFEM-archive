...
subroutine r_sstif(ocpp,ocuu,ocup,ne,w,toxj,body_force)
  ...
  real*8 ::xac(3),xve(3)
  real*8 :: fu,fkup,fp,fkpp,totalh,body_force
...
!ccccccccccccccccccccccccccccccccccccccccccccccccccccc
  ...
  do ni=1,nis
     nu1=             nea(ne,ni)
     nv1=  nn_solid + nea(ne,ni)
     nw1=2*nn_solid + nea(ne,ni)
...
!	totalh=totalh+h(ni)
!	  body_force=body_force+predrf(nu1)
  enddo
!		body_force=body_force+w*sdensit*totalh*xac(1)
!	write(*,*) 'body_force=',body_force, total_vol
  return
