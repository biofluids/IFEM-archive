...
!
 subroutine r_sstif(ocpp,ocup,ne,w,vel,acc,solid_fem_con)
  use r_common
  use solid_variables, only: nsd_solid,nn_solid,nen_solid,ne_solid
  implicit none
...
!ccccccccccc
        ...
        !call r_scalfu_curr(fu,isd,ni,ne,iq)
