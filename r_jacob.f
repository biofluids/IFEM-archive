...
c      xji(1,1) = cf(1,1)/det
c      xji(1,2) = cf(2,1)/det
c      xji(1,3) = cf(3,1)/det
c      xji(2,1) = cf(1,2)/det
c      xji(2,2) = cf(2,2)/det
c      xji(2,3) = cf(3,2)/det
c      xji(3,1) = cf(1,3)/det
c      xji(3,2) = cf(2,3)/det
c      xji(3,3) = cf(3,3)/det
      ...
      xji(2,3) = cf(2,3)/det
      xji(3,3) = cf(3,3)/det
c	write(*,*) 'xji=',xji(1,2),xji(2,1),xji(3,3)
      return
      end
