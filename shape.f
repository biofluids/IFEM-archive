...
c  shape function values
		  sq2d(0,1,iq) = (1 - xq2d(1,iq))
	1		   * (1 - xq2d(2,iq)) * (1 - xq2d(3,iq)) / 8
		  sq2d(0,2,iq) = (1 + xq2d(1,iq))
	1		   * (1 - xq2d(2,iq)) * (1 - xq2d(3,iq)) / 8
		  sq2d(0,3,iq) = (1 + xq2d(1,iq))
	1		   * (1 + xq2d(2,iq)) * (1 - xq2d(3,iq)) / 8
		  sq2d(0,4,iq) = (1 - xq2d(1,iq))
	1		   * (1 + xq2d(2,iq)) * (1 - xq2d(3,iq)) / 8
		  sq2d(0,5,iq) = (1 - xq2d(1,iq))
	1		   * (1 - xq2d(2,iq)) * (1 + xq2d(3,iq)) / 8
		  sq2d(0,6,iq) = (1 + xq2d(1,iq))
	1		   * (1 - xq2d(2,iq)) * (1 + xq2d(3,iq)) / 8
		  sq2d(0,7,iq) = (1 + xq2d(1,iq))
	1		   * (1 + xq2d(2,iq)) * (1 + xq2d(3,iq)) / 8
		  sq2d(0,8,iq) = (1 - xq2d(1,iq))
	1		   * (1 + xq2d(2,iq)) * (1 + xq2d(3,iq)) / 8
