...
OBJ= global_constants.o global_simulation_parameter.o run_variables.o interface_variables.o denmesh_variables.o\
...
gmres_normal.o blockgmres_norm.o points_regen_V2.o block_curv.o\
set_id_curv.o gmres_curv.o blockgmres_curv.o get_inter_normal.o\
get_normal_Bspline.o B_Spline_0order.o B_Spline_1order.o \
get_curv_Bspline.o B_Spline_2order.o get_submesh_info.o point_projection.o\
get_arc_Bspline.o get_surten_Bspline.o get_intervel_fem.o reset_Icenter.o\
get_intervel_Bspline.o get_centerpoint_Ia.o \
B_Spline_inter.o corr_I_fluid_center.o x_smooth.o search_inf_den.o\
get_indicator.o get_weight_derivative.o get_indicator_derivative.o get_normal_curvature.o \
points_regen_in_ele.o regen_in_ele.o
