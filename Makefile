...
ensight_output.o form.o solid_fem_BC.o block.o blockgmres.o gmres.o meshgen_solid.o \
...
set.o shape.o solid_solver.o solid_update.o update.o vol.o r_spiola_elastic2.o 
