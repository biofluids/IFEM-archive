...
subroutine find_sur_domain_pa(x,x_center,x_inter,ne_intlocal,ien_intlocal,hg,nn_local,node_local,I_solid,flag_fnode)
...
!**********************************************!
  support=2.0*hsp  !4*hg is enough for the regenration part
  nn_domain_local=0
  index_local_temp(:)=0
  index_local(:)=0
  domain_nlocal(:)=0
...
end subroutine find_sur_domain_pa
