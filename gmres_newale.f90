...
!ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
	subroutine gmres_newale(x,d,dold,id,w,bg,dg,hg,ien, &
	    z,v,zg,avg,sm,vloc,avloc,h,y,cc,ss,fext,meshvel)
...
!c       compute A * v_j
	   ...
	   call blockgmres_newale(x,d,dold,vloc,avloc,hg,ien,fext,meshvel)
