...
!  cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
subroutine blockgmres_newale(xloc,dloc,doloc,qloc,p,hk,ien,fext,meshvel)
...
!....    calculate vi,dvi/dxj
        do inl=1,nen
		   tempc(1:nsd) = ama*d(1:nsd,inl)+oma*d_old(1:nsd,inl)-meshvel(1:nsd,inl)
...
!.......    Additional nonlinear term form SUPG
 ...
 500	continue 
  ...
  return
end subroutine blockgmres_newale
 quad loop
  enddo  ! end of element loop
