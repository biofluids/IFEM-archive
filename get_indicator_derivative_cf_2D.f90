...
subroutine get_indicator_derivative_cf_2D(x,xp,x_center,hg,I_fluid_center,corr_Ip, &
				  II,dI,ddI,&
				  norm_p, curv_p)
...
!=======================
  ...
  integer index_center(ne),index_inter(nn_inter)
...
123 continue
end subroutine get_indicator_derivative_cf_2D
