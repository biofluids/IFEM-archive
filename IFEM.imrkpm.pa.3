...
parameter(ZERO=0.d0,MACH_EPS=2.d-16)
integer n
...
!************************************************************************
  ...
  real(8) g(0:n-1)
  real(8) AmalD(0:n-1)  ! (0..n-1) auxiliary vector A * d
  real*8  alpha       ! coefficient
  real(8) beta        ! coefficient
  real(8) dividend   ! numerator and denominator of a fraction
  real(8) divisor   ! respectively, used to compute alpha, beta
  real(8) hilf     ! auxiliary variables
  real(8) hilf2    
  real(8) abstand      ! distance of two successive approximations
                       ! for the solution vector x (taken in the
                       ! euclidean norm)
  real(8) xnorm         ! euklidean norm of x
