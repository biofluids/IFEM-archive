subroutine solve_laplace(source,nsd,nn,nn_solid,ien,ne,nen,x_fluid,node_sbc,nn_sbc,I_solid,flag_fnode)
...
time = mpi_wtime()
call block_Laplace(x_fluid,I_solid,p_inter,w_inter,ien,lp_el,count_el,source)
continue
...
call gmres_Laplace(x_fluid,I_solid,w_inter,p_inter,dg,ien,lp_id,lp_el,count_el)
