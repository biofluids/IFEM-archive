...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
	...
	integer i,j,k,ij,jj,i1,j1,k1,l,iqc,igmres,ie,inl
...
!c     compute A * v_j
	   ...
	   call blockgmres_ale(x,d,do,f,vloc,avloc,hg,ien,finv,jac,jaco, &
		refvel,refvelo)
