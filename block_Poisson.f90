...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine  block_Poisson(ne_den_domain,den_domain,xloc,I_fluid_den,p_inter,w_inter,ien_den,norm_fluid)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	node=ien_den(inl,ie)
	do isd=1,nsd
	   p_inter(node)=p_inter(node)+ph(isd,inl)*norm_fluid(isd,node)-ph(isd,inl)*dr(isd)
	end do! residual
	do isd=1,nsd
