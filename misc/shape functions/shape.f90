      ...
      do iq=1,nquad2d
		if(nen.eq.4) then
		  ...
		  sq2d(0,1,iq) = (1 - xq2d(1,iq)) * (1 - xq2d(2,iq)) / 4
		  sq2d(0,2,iq) = (1 + xq2d(1,iq)) * (1 - xq2d(2,iq)) / 4
		  sq2d(0,3,iq) = (1 + xq2d(1,iq)) * (1 + xq2d(2,iq)) / 4
		  sq2d(0,4,iq) = (1 - xq2d(1,iq)) * (1 + xq2d(2,iq)) / 4
		  
		  sq2d(1,1,iq) = - (1 - xq2d(2,iq)) / 4
		  sq2d(1,2,iq) = + (1 - xq2d(2,iq)) / 4
		  sq2d(1,3,iq) = + (1 + xq2d(2,iq)) / 4
		  sq2d(1,4,iq) = - (1 + xq2d(2,iq)) / 4
	
		  sq2d(2,1,iq) = - (1 - xq2d(1,iq)) / 4
		  sq2d(2,2,iq) = - (1 + xq2d(1,iq)) / 4
		  sq2d(2,3,iq) = + (1 + xq2d(1,iq)) / 4
		  sq2d(2,4,iq) = + (1 - xq2d(1,iq)) / 4
