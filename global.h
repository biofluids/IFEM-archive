      ...
      integer dbnodes(nsdpad),dbnodestot(nsdpad)
      integer decount(nsdpad),decounttot(nsdpad)
      common  dbnodes,dbnodestot,decount,decounttot
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      integer dorder,dnz,dlicn,dlirn
      real* 8 damat(1),drhs(1)
      integer dicoln(1),dirown(1),dikeep(1),diw(1)
      real* 8 dwgt(1)
      integer dbctype(nsdpad)
      pointer (damatptr,damat),(drhsptr,drhs),(dicolnptr,dicoln)
      pointer (dirownptr,dirown)
      pointer (dikeepptr,dikeep),(diwptr,diw),(dwgtptr,dwgt)
      common  dorder,dnz,dlicn,dlirn,dbctype
      common  damatptr,drhsptr,dicolnptr,dirownptr,dikeepptr
      common  diwptr,dwgtptr
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
