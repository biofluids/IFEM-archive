      ...
      xr(1,1) = 0
      xr(1,1) = xr(1,1) + sq(1,1,iq) * x(1, 1) + sq(1,2,iq) * x(1, 2)
      xr(1,1) = xr(1,1) + sq(1,3,iq) * x(1, 3) + sq(1,4,iq) * x(1, 4)
      xr(1,1) = xr(1,1) + sq(1,5,iq) * x(1, 5) + sq(1,6,iq) * x(1, 6)
      xr(1,1) = xr(1,1) + sq(1,7,iq) * x(1, 7) + sq(1,8,iq) * x(1, 8)

      xr(1,2) = 0
      xr(1,2) = xr(1,2) + sq(1,1,iq) * x(2, 1) + sq(1,2,iq) * x(2, 2)
      xr(1,2) = xr(1,2) + sq(1,3,iq) * x(2, 3) + sq(1,4,iq) * x(2, 4)
      xr(1,2) = xr(1,2) + sq(1,5,iq) * x(2, 5) + sq(1,6,iq) * x(2, 6)
      xr(1,2) = xr(1,2) + sq(1,7,iq) * x(2, 7) + sq(1,8,iq) * x(2, 8)

      xr(1,3) = 0 
      xr(1,3) = xr(1,2) + sq(1,1,iq) * x(3, 1) + sq(1,2,iq) * x(3, 2)
      xr(1,3) = xr(1,2) + sq(1,3,iq) * x(3, 3) + sq(1,4,iq) * x(3, 4)
      xr(1,3) = xr(1,2) + sq(1,5,iq) * x(3, 5) + sq(1,6,iq) * x(3, 6)
      xr(1,3) = xr(1,2) + sq(1,7,iq) * x(3, 7) + sq(1,8,iq) * x(3, 8)

      xr(2,1) = 0
      xr(2,1) = xr(2,1) + sq(2,1,iq) * x(1, 1) + sq(2,2,iq) * x(1, 2)
      xr(2,1) = xr(2,1) + sq(2,3,iq) * x(1, 3) + sq(2,4,iq) * x(1, 4)
      xr(2,1) = xr(2,1) + sq(2,5,iq) * x(1, 5) + sq(2,6,iq) * x(1, 6)
      xr(2,1) = xr(2,1) + sq(2,7,iq) * x(1, 7) + sq(2,8,iq) * x(1, 8)

      xr(2,2) = 0
      xr(2,2) = xr(2,2) + sq(2,1,iq) * x(2, 1) + sq(2,2,iq) * x(2, 2)
      xr(2,2) = xr(2,2) + sq(2,3,iq) * x(2, 3) + sq(2,4,iq) * x(2, 4)
      xr(2,2) = xr(2,2) + sq(2,5,iq) * x(2, 5) + sq(2,6,iq) * x(2, 6)
      xr(2,2) = xr(2,2) + sq(2,7,iq) * x(2, 7) + sq(2,8,iq) * x(2, 8)

      xr(2,3) = 0
      xr(2,3) = xr(2,3) + sq(2,1,iq) * x(3, 1) + sq(2,2,iq) * x(3, 2)
      xr(2,3) = xr(2,3) + sq(2,3,iq) * x(3, 3) + sq(2,4,iq) * x(3, 4)
      xr(2,3) = xr(2,3) + sq(2,5,iq) * x(3, 5) + sq(2,6,iq) * x(3, 6)
      xr(2,3) = xr(2,3) + sq(2,7,iq) * x(3, 7) + sq(2,8,iq) * x(3, 8)

      xr(3,1) = 0
      xr(3,1) = xr(3,1) + sq(3,1,iq) * x(1, 1) + sq(3,2,iq) * x(1, 2)
      xr(3,1) = xr(3,1) + sq(3,3,iq) * x(1, 3) + sq(3,4,iq) * x(1, 4)
      xr(3,1) = xr(3,1) + sq(3,5,iq) * x(1, 5) + sq(3,6,iq) * x(1, 6)
      xr(3,1) = xr(3,1) + sq(3,7,iq) * x(1, 7) + sq(3,8,iq) * x(1, 8)

      xr(3,2) = 0
      xr(3,2) = xr(3,2) + sq(3,1,iq) * x(2, 1) + sq(3,2,iq) * x(2, 2)
      xr(3,2) = xr(3,2) + sq(3,3,iq) * x(2, 3) + sq(3,4,iq) * x(2, 4)
      xr(3,2) = xr(3,2) + sq(3,5,iq) * x(2, 5) + sq(3,6,iq) * x(2, 6)
      xr(3,2) = xr(3,2) + sq(3,7,iq) * x(2, 7) + sq(3,8,iq) * x(2, 8)

      xr(3,3) = 0
      xr(3,3) = xr(3,3) + sq(3,1,iq) * x(3, 1) + sq(3,2,iq) * x(3, 2)
      xr(3,3) = xr(3,3) + sq(3,3,iq) * x(3, 3) + sq(3,4,iq) * x(3, 4)
      xr(3,3) = xr(3,3) + sq(3,5,iq) * x(3, 5) + sq(3,6,iq) * x(3, 6)
      xr(3,3) = xr(3,3) + sq(3,7,iq) * x(3, 7) + sq(3,8,iq) * x(3, 8)
