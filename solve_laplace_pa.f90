subroutine solve_laplace_pa(source,nsd,nn,nn_solid,ien,ne,nen,x_fluid,node_sbc,nn_sbc,I_solid,flag_fnode,&
...
time = mpi_wtime()
call block_Laplace(x_fluid,I_solid,p_inter,w_inter,ien,ien_local,ne_local,source)
...
call gmres_Laplace_pa(x_fluid,I_solid,w_inter,p_inter,dg,ien,lp_id,&
	ne_local,ien_local,nn_local,node_local,send_address,ad_length,&
	global_com,nn_global_com,local_com,nn_local_com)
