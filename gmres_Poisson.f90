...
subroutine gmres_Poisson(cal_ne,cal_domain,x,d,w,bg,dg,ien_den,bcnode_den,&
...
!!!!!!!!!!!!!!!!start inner loop!!!!!!!!!!!!!
	   do j=1,inner
		...
		avloc(:) = 0.0d0
		call blockgmres_Poisson(cal_ne,cal_domain,x,dv,avloc,ien_den)
