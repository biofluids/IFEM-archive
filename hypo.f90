...
!=============================
!  vis_solid=  1.0         % evaluation moved to parseinput.f90 by Jubiao Yang on Mar. 2, 2013
  I_fluid(:)=0.0
  solid_pave(:)=0.0d0
  solid_vel(:,:) = 0.0d0
  solid_accel(:,:) = 0.0d0
!  damp_solid = 100.0      % evaluation moved to parseinput.f90 by Jubiao Yang on Mar. 2, 2013
  solid_bcvel(:,:) = 0.0
  solid_bcvel_old(:,:) = 0.0
  outedge=2
  fden(:)=0.0
...
!+++++++++++++++++++++++++++++++++++++++++++
! if (myid==0) write(*,*) 'vis_solid=', vis_solid, ';damp_solid', damp_solid, 'kappa_s', kappa_s
!+++++++++++++++++++++++++++++++++++++++++++
